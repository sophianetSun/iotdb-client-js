...
export interface ITPipeTransferRespArgs {
    status: org_apache_iotdb_common_rpc_thrift.TSStatus;
    body?: Buffer;
}
export class TPipeTransferResp {
    public status: org_apache_iotdb_common_rpc_thrift.TSStatus;
    public body?: Buffer;
    constructor(args: ITPipeTransferRespArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.body != null) {
            output.writeFieldBegin("body", thrift.Thrift.Type.STRING, 2);
    ...
    public static read(input: thrift.TProtocol): TPipeTransferResp {
        ...
        if (_args.status !== undefined) {
            return new TPipeTransferResp(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read TPipeTransferResp from input");
        }
    }
}
