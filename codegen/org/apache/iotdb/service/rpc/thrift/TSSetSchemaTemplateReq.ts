...
export interface ITSSetSchemaTemplateReqArgs {
    sessionId: number | Int64;
    templateName: string;
    prefixPath: string;
}
export class TSSetSchemaTemplateReq {
    public sessionId: Int64;
    public templateName: string;
    public prefixPath: string;
    constructor(args: ITSSetSchemaTemplateReqArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.prefixPath != null) {
            output.writeFieldBegin("prefixPath", thrift.Thrift.Type.STRING, 3);
    ...
    public static read(input: thrift.TProtocol): TSSetSchemaTemplateReq {
        ...
        input.readStructEnd();
        if (_args.sessionId !== undefined && _args.templateName !== undefined && _args.prefixPath !== undefined) {
            return new TSSetSchemaTemplateReq(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read TSSetSchemaTemplateReq from input");
        }
    }
}
