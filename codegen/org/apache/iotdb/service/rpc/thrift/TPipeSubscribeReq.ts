...
export interface ITPipeSubscribeReqArgs {
    version: number;
    type: number;
    body?: Buffer;
}
export class TPipeSubscribeReq {
    public version: number;
    public type: number;
    public body?: Buffer;
    constructor(args: ITPipeSubscribeReqArgs) {
    ...
    public static read(input: thrift.TProtocol): TPipeSubscribeReq {
        ...
        input.readStructEnd();
        if (_args.version !== undefined && _args.type !== undefined) {
            return new TPipeSubscribeReq(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read TPipeSubscribeReq from input");
        }
    }
}
