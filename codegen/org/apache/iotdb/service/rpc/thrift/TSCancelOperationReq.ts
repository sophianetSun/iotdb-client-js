...
export interface ITSCancelOperationReqArgs {
    sessionId: number | Int64;
    queryId: number | Int64;
}
export class TSCancelOperationReq {
    public sessionId: Int64;
    public queryId: Int64;
    constructor(args: ITSCancelOperationReqArgs) {
    ...
    public static read(input: thrift.TProtocol): TSCancelOperationReq {
        ...
        if (_args.sessionId !== undefined && _args.queryId !== undefined) {
            return new TSCancelOperationReq(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read TSCancelOperationReq from input");
        }
    }
}
