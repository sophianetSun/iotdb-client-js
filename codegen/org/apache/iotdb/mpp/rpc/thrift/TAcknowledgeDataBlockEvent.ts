...
export class TAcknowledgeDataBlockEvent {
    ...
    public index: number;
    constructor(args: ITAcknowledgeDataBlockEventArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("TAcknowledgeDataBlockEvent");
    ...
    public static read(input: thrift.TProtocol): TAcknowledgeDataBlockEvent {
        ...
        if (_args.sourceFragmentInstanceId !== undefined && _args.startSequenceId !== undefined && _args.endSequenceId !== undefined && _args.index !== undefined) {
            return new TAcknowledgeDataBlockEvent(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read TAcknowledgeDataBlockEvent from input");
        }
    }
}
