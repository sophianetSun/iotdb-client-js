...
export class TConstructSchemaBlackListWithTemplateReq {
    ...
    constructor(args: ITConstructSchemaBlackListWithTemplateReqArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("TConstructSchemaBlackListWithTemplateReq");
    ...
    public static read(input: thrift.TProtocol): TConstructSchemaBlackListWithTemplateReq {
        ...
        if (_args.schemaRegionIdList !== undefined && _args.templateSetInfo !== undefined) {
            return new TConstructSchemaBlackListWithTemplateReq(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read TConstructSchemaBlackListWithTemplateReq from input");
        }
    }
}
