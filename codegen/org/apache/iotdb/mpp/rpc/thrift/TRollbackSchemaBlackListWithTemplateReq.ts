...
export class TRollbackSchemaBlackListWithTemplateReq {
    ...
    constructor(args: ITRollbackSchemaBlackListWithTemplateReqArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("TRollbackSchemaBlackListWithTemplateReq");
    ...
    public static read(input: thrift.TProtocol): TRollbackSchemaBlackListWithTemplateReq {
        ...
        if (_args.schemaRegionIdList !== undefined && _args.templateSetInfo !== undefined) {
            return new TRollbackSchemaBlackListWithTemplateReq(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read TRollbackSchemaBlackListWithTemplateReq from input");
        }
    }
}
