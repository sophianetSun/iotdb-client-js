...
export interface ITFetchMoreDataReqArgs {
    queryId: number | Int64;
    timeout?: number | Int64;
    fetchSize?: number;
}
export class TFetchMoreDataReq {
    public queryId: Int64;
    public timeout?: Int64;
    public fetchSize?: number;
    constructor(args: ITFetchMoreDataReqArgs) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("TFetchMoreDataReq");
        if (this.queryId != null) {
            output.writeFieldBegin("queryId", thrift.Thrift.Type.I64, 1);
            output.writeI64(this.queryId);
            output.writeFieldEnd();
        }
        if (this.timeout != null) {
            output.writeFieldBegin("timeout", thrift.Thrift.Type.I64, 2);
    ...
    public static read(input: thrift.TProtocol): TFetchMoreDataReq {
        ...
        if (_args.queryId !== undefined) {
            return new TFetchMoreDataReq(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read TFetchMoreDataReq from input");
        }
    }
}
